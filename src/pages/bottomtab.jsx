...
function bottom() {
   ...
   const minimize = () => {
    if (Capacitor.getPlatform() === "android") {
        ...
        console.log("exitApp() is not supported on web");
    }
    };
         ...
         {!hideBottom && (
            <div className='bottombtm-min'>
                <div className='bottombtm'>
                    ...
                    <a onClick={() => history.push('/watchlist')} size='small'>
                    ...
                    <a onClick={() => history.push('/basket')} size='small' >
