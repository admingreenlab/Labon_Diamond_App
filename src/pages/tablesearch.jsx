...
function Tablesearch() {
  ...
  const handleExportSelectedToExcel = async () => {
    ...
    if (selectedRows.length > 2000) {
      window.alert("You can export a maximum of 2000 stones at a time.");
      return;
    }
    try {
        setIsLoadingAll(true);
                            ...
                            <tr key={index}>
                              ...
                              <td>
                                <a
                                  ...
                                  href={
                                    item.LAB === "IGI"
                                      ? `https://www.igi.org/reports/verify-your-report?r=${item.REPORTNO}`
                                      : `https://www.gia.edu/report-check?reportno=${item.REPORTNO}`
                                  }
                                  target="_blank"
                                >
                                  {item.LAB}
